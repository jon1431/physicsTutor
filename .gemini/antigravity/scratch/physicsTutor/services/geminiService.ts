...
/**
 * Enhanced System Prompt to mirror the "Study Notes" aesthetic for the Tutor:
 * - Clear headers (###)
 * - Thematic dividers (---)
 * - Standardized symbols (w for angular frequency)
 * - Strict LaTeX math with proper fraction syntax
 */
...
// Shared instruction for standardized math across all tools
// Added explicit instructions for delimiters $...$ and $$...$$
const MATH_STANDARD = "MANDATORY: Use strict LaTeX for all mathematical expressions. You MUST wrap every formula, symbol, or equation in $...$ for inline math (e.g. $F=ma$) or $$...$$ for block formulas. For fractions, use \\frac{a}{b} syntax only. Use the letter 'w' for angular frequency (NOT the Greek omega). Ensure clear step-by-step logic.";
...
/**
 * Condenses long notes into a structured summary.
 * Uses gemini-3-flash-preview for the summarization task.
 */
...
/**
 * Analyzes an image of a physics problem.
 * Uses gemini-3-pro-preview for complex reasoning and multimodal processing.
 */
